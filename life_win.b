...
<<<<[>+<--[>>.>>>>>++<<<<<<<  <--[-[[-]>-<]>[->>>>>>>+<<<<<<<]>-<<]>>[-<->>>>>>>+<<<<<<]<  ]
# проверяем была ли ячейка мертвой выводим символ и смотрим не надо ли оживить
>[>>.>>>>++<<<<<<<<---[[-]>>-<<]>>[->>>>>>+<<<<<<]]>[[-<<+>>]>]
# если ячейка была живой то выводим нужный символ и смотрим не надо ли умертвить
<<+<-[>-<[->>+<<]]>[->++++++++++.--<]>[-<<+>>]<<<<<<]
